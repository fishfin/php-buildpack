    ...
    def install_extensions(self):
        ...
        for ibmdbExtn in ['IBM_DB2']: #, 'PDO', 'PDO_IBM']:
           ...
           #              self._phpExtnDir])
            ...
            phpBinDir1 = os.path.join(phpRoot1, 'bin')                        
            phpBinPath = os.path.join(phpBinDir, 'php')
            phpBinPath1 = os.path.join(phpBinDir1, 'php')                        
            phpIniDir = os.path.join(phpRoot, 'etc')
            phpizeExec = os.path.join(phpBinDir, '/phpize')
            ...
            self._runCmd(os.environ,self._ctx['BUILD_DIR'], [phpizeExec])
