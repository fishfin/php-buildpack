    ...
    def install_extensions(self):
        ...
        for ibmdbExtn in ['IBM_DB2']: #, 'PDO', 'PDO_IBM']:
           ...
           #              self._phpExtnDir])
            ...
            self._logMsg(self._runCmd(os.environ, [self._phpBinPath,'-i']))
            self._logMsg(self._runCmd(os.environ, [self._phpBinPath1,'-i']))
